 ...
 */
final class Version20250124194107 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(255) NOT NULL, number VARCHAR(35) DEFAULT NULL COMMENT \'(DC2Type:phone_number)\', username VARCHAR(25) NOT NULL, password VARCHAR(255) NOT NULL, profile_picture LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
